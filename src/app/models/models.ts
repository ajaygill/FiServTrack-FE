...
export interface Account { id:number; name:string; groupId?:number|null; frequencyId?:number|null; trackingDate?:string; paymentDay?:number; accountTypeId?:number|null; isLoan:boolean; loanTypeId?:number|null; loanRepaymentType?:LoanRepaymentType|null; openingBalance:number; installmentAmount?:number; noOfInstallments?:number; fixedAmount?:number; currencyId?:number|null; budgetAmount?:number; parentAccountId?:number|null; associateAccountId?:number|null; parentAccount?:{ id:number; name:string }; associateAccount?:{ id:number; name:string }; isActive:boolean; planBudget:boolean; setAlerts:boolean; }
